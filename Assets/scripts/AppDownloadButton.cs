...
public class AppDownloadButton : MonoBehaviour
{
    ...
    {
        FirebaseAnalyticsManager.LogDownloadHiddenFlorence(FirebaseAnalyticsManager.PlatformType.iOS);
        Application.OpenURL("https://apps.apple.com/us/app/hidden-florence/id896723912");
    }

    public void OpenAndroidPage()
    {
        FirebaseAnalyticsManager.LogDownloadHiddenFlorence(FirebaseAnalyticsManager.PlatformType.Android);
